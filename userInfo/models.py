...
class UserCeprunsaPersonalInfo(models.Model):
  ...
  phone = models.CharField(max_length=9, db_column='main_phone')
  ...
  secondPhone = models.CharField(max_length=9, db_column='second_phone', blank=True, null=True)
...
class UserCeprunsaPaymentInfo(models.Model):
  ...
  bankEntity = models.CharField(max_length=100, db_column='bank_entity')
  bankAccount = models.CharField(max_length=20, db_column='bank_account')
